...
class QLearningTable:
    ...
    def chooseAction(self, observation, occasion):
        ...
        if np.random.uniform() < self.epsilon:
            ...
            action = np.random.choice(np.array([0,1])) # choose random action
        return int(action)
    ...
    def writeLearnLog(self, epi, current_step, s, o, a, r): # record each experience
    ...
    def writeMemoryRecord(self, o, s, a, r): # everytime when it's the end of green phase
